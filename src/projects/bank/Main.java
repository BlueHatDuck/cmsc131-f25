...
public class Main {
    ...
    public static void phase1() {
        ...
        try {
            ...
            Bank bank = new Bank();
            int numAccounts0 = bank.totalAccounts();
            // TODO run after fixing signature
            // int findAcct0 = bank.find(acct.getAccountID());
            int findAcct0 = -1;

            boolean addResult = bank.addAccount(acct);
            int numAccounts1 = bank.totalAccounts();
            // TODO run after fixing signature
            // int findAcct1 = bank.find(acct.getAccountID());
            int findAcct1 = 0;
